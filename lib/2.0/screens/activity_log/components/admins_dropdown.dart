...
class AdminsDropDown extends StatefulWidget {
  const AdminsDropDown({Key key}) : super(key: key);

  @override
  State<AdminsDropDown> createState() => _AdminsDropDownState();
}

class _AdminsDropDownState extends State<AdminsDropDown>
    with AutomaticKeepAliveClientMixin<AdminsDropDown> {
  bool _isVisited = false;
  @override
  bool get wantKeepAlive => _isVisited;
  FirestoreService firestoreService = FirestoreService();
  String emailDropdownValue;
  Stream<List<Admin>> _streamAdminsAccount;
  @override
  void initState() {
    _streamAdminsAccount = firestoreService.getAllAdmins();
    setState(() {
      _isVisited = true;
    });
  }
