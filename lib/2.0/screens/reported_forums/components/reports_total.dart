...
class ReportsTotal extends StatefulWidget {
  ...
  @override
  State<ReportsTotal> createState() => _ReportsTotalState();
}

class _ReportsTotalState extends State<ReportsTotal>
    with AutomaticKeepAliveClientMixin<ReportsTotal> {
