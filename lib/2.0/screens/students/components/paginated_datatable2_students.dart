...
// class PaginatedDataTable2Students extends StatefulWidget {
//   Stream<List<Student>> streamStudents;
//   PaginatedDataTable2Students({Key key, @required this.streamStudents})
//       : super(key: key);

//   @override
//   _PaginatedDataTable2StudentsState createState() =>
//       _PaginatedDataTable2StudentsState();
// }

// class _PaginatedDataTable2StudentsState
//     extends State<PaginatedDataTable2Students> {
